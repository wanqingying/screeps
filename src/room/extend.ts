...
export class RoomExtend {
  ...
  // @CacheValid<SourceExt[]>(desc => {
  //   const tick = Game.time - desc.tick;
  //   if (tick % 4 !== 0 && desc.result) {
  //     return true;
  //   }
  //   const exts = desc.result || [];
  //   const valid = exts.every(x => {
  //     return Game.getObjectById(x.container?.id) && Game.getObjectById(x.harvester);
  //   });
  //   return tick <= 17 && valid;
  // })
  // public get_sources_ext(): SourceExt[] {
